...
### Plots
![](bottleneck_de_vs_differential_entropy_aggregated_bayesian_quantizer.png)
![](bottleneck_de_vs_differential_entropy_aggregated_equal_width_quantizer.png)
![](bottleneck_de_vs_differential_entropy_aggregated_hdbscan_quantizer.png)
![](bottleneck_de_vs_differential_entropy_individual_bayesian_quantizer.png)
![](bottleneck_de_vs_differential_entropy_individual_equal_width_quantizer.png)
![](bottleneck_de_vs_differential_entropy_individual_hdbscan_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_aggregated_bayesian_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_aggregated_equal_width_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_aggregated_hdbscan_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_individual_bayesian_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_individual_equal_width_quantizer.png)
![](bottleneck_full_vn_entropy_vs_differential_entropy_individual_hdbscan_quantizer.png)
![](bottleneck_full_vn_entropy_vs_hurst_exponent_aggregated.png)
![](bottleneck_full_vn_entropy_vs_hurst_exponent_individual.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_aggregated_bayesian_quantizer.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_aggregated_equal_width_quantizer.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_aggregated_hdbscan_quantizer.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_individual_bayesian_quantizer.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_individual_equal_width_quantizer.png)
![](bottleneck_full_vn_entropy_vs_lempel_ziv_complexity_individual_hdbscan_quantizer.png)
![](bottleneck_full_vn_entropy_vs_optimized_mpe_aggregated.png)
![](bottleneck_full_vn_entropy_vs_optimized_mpe_individual.png)
![](bottleneck_he_vs_hurst_exponent_aggregated.png)
![](bottleneck_he_vs_hurst_exponent_individual.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_aggregated_bayesian_quantizer.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_aggregated_equal_width_quantizer.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_aggregated_hdbscan_quantizer.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_individual_bayesian_quantizer.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_individual_equal_width_quantizer.png)
![](bottleneck_lzc_vs_lempel_ziv_complexity_individual_hdbscan_quantizer.png)
![](bottleneck_mpe_vs_optimized_mpe_aggregated.png)
![](bottleneck_mpe_vs_optimized_mpe_individual.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_aggregated_bayesian_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_aggregated_equal_width_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_aggregated_hdbscan_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_individual_bayesian_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_individual_equal_width_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_differential_entropy_individual_hdbscan_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_hurst_exponent_aggregated.png)
![](bottleneck_mw_global_entanglement_vs_hurst_exponent_individual.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_aggregated_bayesian_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_aggregated_equal_width_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_aggregated_hdbscan_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_individual_bayesian_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_individual_equal_width_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_lempel_ziv_complexity_individual_hdbscan_quantizer.png)
![](bottleneck_mw_global_entanglement_vs_optimized_mpe_aggregated.png)
![](bottleneck_mw_global_entanglement_vs_optimized_mpe_individual.png)
![](mean_bottleneck_trash_loss.png)
![](mean_gradient_norms.png)
![](mean_prediction_loss.png)
![](sample_bottleneck_trash_loss.png)
![](sample_gradient_norms.png)
![](sample_prediction_loss.png)
